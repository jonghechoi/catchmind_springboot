...
//	private PagingServiceImpl pagingService;
	...
	@RequestMapping(value = "/member_list_paging", method = RequestMethod.GET, produces="text/plain;charset=UTF-8")
	@ResponseBody
	...
	@RequestMapping(value = "/member_modify_data", method = RequestMethod.GET)
	@ResponseBody 
	public String admin_member_modify_data(String mid, Model model) {
		return mid;
	}

	@RequestMapping(value = "/member_modify_update", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/admin_shop_information", method = RequestMethod.GET)
	public String admin_shop_information() {
		return "pages/admin/admin_shop_information";
	}
	
	@RequestMapping(value = "/admin_shop_information_List", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/admin_review_list", method = RequestMethod.GET, produces="text/plain;charset=UTF-8")
	@ResponseBody
	public String admin_review_list(String page) {
		return adminService.getReviewSelectGson(page);
	}
	
	@RequestMapping(value = "/admin_review_detail", method = RequestMethod.GET, produces="text/plain;charset=UTF-8")
	...
	@RequestMapping(value = "/admin_review_selected", method = RequestMethod.GET, produces="text/plain;charset=UTF-8")
	...
	@RequestMapping(value = "/admin_review_detail_data", method = RequestMethod.GET)
	@ResponseBody
	public String admin_review_detail_data(String rid) {
		return String.valueOf(adminService.getReviewMainUpdate(rid));
	}
	
	@RequestMapping(value = "/admin_review_detail_delete_data", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/notice_list_paging", method = RequestMethod.GET, produces="text/plain;charset=UTF-8")
	@ResponseBody
	public String admin_notice_list_paging(String page) {
		return adminService.getNoticeSelectGson(page);
	}
	
	@RequestMapping(value = "/admin_notice_content", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/notice_delete_proc", method = RequestMethod.GET)
	@ResponseBody
