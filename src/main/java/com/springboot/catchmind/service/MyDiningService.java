...
//
//	ArrayList<ScheduledDto> getVisited(String mid);
//
//	ScheduledDto getInformation(String mid, String sid, String rid);
//
//	ArrayList<ScheduledDto> getScheduled(String mid);
//
//	int getTotalRowCount(String mid);
//
//	ArrayList<ScheduledDto> getVisitedSelect(Map<String,String> param);
//
