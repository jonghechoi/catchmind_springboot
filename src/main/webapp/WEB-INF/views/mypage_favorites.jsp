...
<script>
	function bookmark(fid){
		location.href = "bookmark_delete_proc.do?fid="+fid+"&mid=${mid}";
                            ...
                            <c:if test="${sessionScope.sessionVo.roleId =='SHOP' or sessionScope.sessionVo.roleId == 'ADMIN'}">
	                            <li class="nav-item submenu dropdown">
	                                ...
	                                <ul class="dropdown-menu">
	                                    ...
	                                    <li class="nav-item"><a class="nav-link" href="shop_reservation.do?sid=S${sessionScope.sessionVo.sid}">Reservation</a></li>
	                                </ul>
	                            </li>
                            </c:if>     
