...
<html lang="en">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="accomodation.html">MYDINING</a></li>
                            ...
                            <li class="nav-item active"><a class="nav-link" href="elements.html">NOTICE</a></li>
        ...
        <section class="breadcrumb_area blog_banner_two">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="index.html">MY PEGE</a></li>
    ...
    <div><p style="text-align:center"><button class="btn btn-lg btn-red">Save</button></p></div>
</div>
	</div>
