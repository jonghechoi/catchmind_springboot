        ...
        <header class="header_area">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="navbar-brand logo_h" href="index.html"><img src="http://localhost:9000/test1/royal-master/image/catch/KakaoTalk_20230507_132927423.png" alt=""></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="about.html">Search</a></li>
                            <li class="nav-item submenu dropdown">
                                <a href="accomodation.html" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">MyDINING</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item active"><a class="nav-link" href="accomodation.html">Scheduled</a></li>
                                    <li class="nav-item"><a class="nav-link" href="visited.html">Visited</a></li>
                                </ul>
                            </li> 
                            <li class="nav-item"><a class="nav-link" href="gallery.html">MyPAGE</a></li>
                            <li class="nav-item"><a class="nav-link" href="contact.html">NOTICE</a></li>
                            <li class="nav-item"><a class="nav-link" href="elements.html">ADMIN</a></li>
                        </ul>
                    </div> 
                </nav>
            </div>
            ...
            <div class="container">
                ...
                <div class="row mb_30">
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img"><a href="#" ="btn-bookmark active"></a>
                                <img src="http://localhost:9000/test1/royal-master/image/catch/22056_21102411463332046.jpg" width="262px"; height="272px"; alt="">
                            </div>
                            <a href="#"><h4 class="sec_h4">Aruhi Niwa</h4></a>
                            <span class="__date">Dec 08, 2022</span>    <span class="star">★ 5.0</span>
                            <h5>The owner was so good at making things,<br> so I really enjoyed the sashimi<br>
                          <small></small></h5>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img"><a href="#" ="btn-bookmark active"></a>
                                <img src="http://localhost:9000/test1/royal-master/image/catch/230507151506597.jpeg" width="262px"; height="272px"; alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img"><a href="#" ="btn-bookmark active"></a>
                                <img src="http://localhost:9000/test1/royal-master/image/catch/2357191245568_rv.jpg" width="262px"; height="272px"; alt="">
                            </div>
                     ...
                     <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img"><a href="#" ="btn-bookmark active"></a>
                                <img src="http://localhost:9000/test1/royal-master/image/catch/8r8kcx3xrkmc7pfi7lezba_2341518181244717.jpg" width="262px"; height="272px"; alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img"><a href="#" ="btn-bookmark active"></a>
                                <img src="http://localhost:9000/test1/royal-master/image/catch/rsvnvk29u-g1xal0gqzppg_22111523302100765.jpg" width="262px"; height="272px"; alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img"><a href="#" ="btn-bookmark active"></a>
                                <img src="http://localhost:9000/test1/royal-master/image/catch/230417233948722(0).jpeg" width="262px"; height="272px"; alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img"><a href="#" ="btn-bookmark active"></a>
                                <img src="http://localhost:9000/test1/royal-master/image/catch/230509200719537(0).jpeg" width="262px"; height="272px"; alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img"><a href="#"="btn-bookmark active"></a>
                                <img src="http://localhost:9000/test1/royal-master/image/catch/23225170303149_rv.jpg" width="262px"; height="272px"; alt="">
                            </div>
