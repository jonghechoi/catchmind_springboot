        				...
        				<!--================ 占쏙옙占쏙옙占싹댐옙 占싸븝옙 =================-->                
                            ...
                            <c:if test="${sessionScope.sessionVo.roleId =='SHOP' or sessionScope.sessionVo.roleId == 'ADMIN'}">
	                            <li class="nav-item submenu dropdown">
	                                ...
	                                <ul class="dropdown-menu">
	                                    <li class="nav-item active"><a class="nav-link" href="/shop_information.do/${sessionScope.sessionVo.sid}">Register</a></li>
	                                    <li class="nav-item"><a class="nav-link" href="/shop_reservation.do/${sessionScope.sessionVo.sid}">Reservation</a></li>
	                                </ul>
	                            </li>
                            </c:if>     
